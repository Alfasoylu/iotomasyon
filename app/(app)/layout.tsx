...
const ALL_NAV: Array<NavItem & { permission?: string }> = [
  ...
  { href: "/admin/trendyol-catalog",    label: "Trendyol Katalog",         permission: PERMISSIONS.EXECUTIVE_READ },
  ...
  { href: "/admin/import-cockpit",       label: "İthalat Cockpiti v2",  permission: PERMISSIONS.EXECUTIVE_READ },
  { href: "/admin/import-decisions",    label: "İthalat Kararları v1",  permission: PERMISSIONS.EXECUTIVE_READ },
  ...
  { href: "/marketplace/realized-margin",    label: "Gerçekleşen Marj",  permission: PERMISSIONS.EXECUTIVE_READ },
  { href: "/marketplace/return-analysis",    label: "İade Analizi",       permission: PERMISSIONS.MARKETPLACE_RETURNS_READ },
