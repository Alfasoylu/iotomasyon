      ...
      <div className="rounded-xl border border-slate-200 bg-white overflow-auto max-h-[calc(100vh-260px)]">
          <table className="min-w-full divide-y divide-slate-100 text-sm">
            ...
            <tbody className="divide-y divide-slate-50 bg-white">
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={24} className="px-4 py-12 text-center text-slate-400 text-sm">
                    ...
                    >
                      ...
                      <td className="px-3 py-2">
                        <div className="flex flex-col items-start gap-1">
                          {p.sourceLinks.map((link, index) => (
                            <a
                              key={link.id}
                              href={link.url}
                              target="_blank"
                              rel="noreferrer"
                              className="text-[10px] font-medium text-orange-600 underline-offset-2 hover:underline"
                            >
