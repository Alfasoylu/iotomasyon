// XML senkron çekirdeği — BİLİNÇLİ olarak "use server" modülü DEĞİL.
//
// Güvenlik (2026-09-14 taraması, S-Y1): "use server" dosyasındaki her export
// kimlik doğrulamasız çağrılabilen bir server action'a dönüşür. runSync buradayken
// herkes keyfi URL + Authorization header ile SSRF tetikleyip ürün/stok yazabiliyordu.
// Artık yalnız yetkili action (lib/actions/xml-sync-actions.ts → triggerXmlSyncAction)
// ve cron route (app/api/cron/xml-sync) çağırır. Bu dosyaya "use server" EKLEMEYİN.
