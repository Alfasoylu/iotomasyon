...
- trendyol rapor ay drill-down (Phase 70, 2026-05-17): /admin/trendyol-report aylık tablo satırları tıklanabilir link (→?month=YYYY-MM); seçili ay koyu arka planla vurgulanan; top-10 ürünler seçili aya göre filtreleniyor; "← Son 30 güne dön" link; drillLabel dinamik; no schema change; tsc clean; commit 34b83e2; PENDING DEPLOY /admin/trendyol-report aylık tablo satırları tıklanabilir link (→?month=YYYY-MM); seçili ay koyu arka planla vurgulanan; top-10 ürünler seçili aya göre filtreleniyor; "← Son 30 güne dön" link; searchParams eklendi; drillLabel "Son 30 Gün" → "Nis 2026" gibi değişiyor; no schema change; tsc clean; commit 34b83e2; PENDING DEPLOY
- siparişler sayfası arama (Phase 69, 2026-05-17): /orders sayfasına ürün adı/barkod/SKU/sipariş no arama eklendi; q param; searchFilter Prisma OR; tab counts arama ile güncelleniyor; iade sekmesinde productName filtresi; tabHref q'yu koruyor; Temizle butonu; no schema change; tsc clean; commit 6986a2e; PENDING DEPLOY
- xml stok hareketi geçmişi ürün detay (Phase 68, 2026-05-17): /products/[id] sayfasına "XML Stok Değişim Geçmişi" kartı eklendi; XmlStockChangeLog son 30 kayıt; tarih/önceki/yeni/delta tablo; emerald artış / red azalış; StockAdjustmentCard'ın üzerinde; no schema change; tsc clean; commit 24fb968; PENDING DEPLOY
