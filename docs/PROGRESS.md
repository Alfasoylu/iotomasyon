...
- dashboard role-based workspaces (Phase 54 Faz A+B+C, 2026-05-17): single /dashboard URL branches on user.role server-side; AdminWorkspace extracted; SalesWorkspace (pipeline, today tasks, recent activity — no financial data); OperationsWorkspace (open/overdue/today tasks, critical/low stock, unmatched orders, 7d Trendyol qty — no financial data); READY dpl_ESQS1sQTWPXrs4iCPhUeEG7QtpCY
